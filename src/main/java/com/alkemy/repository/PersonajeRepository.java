...
//    @Query (value = "SELECT p.nombre, p.imagen FROM personaje AS p INNER JOIN personaje_pelicula AS pp ON pp.id_pelicula = 1;", nativeQuery= true)
//    public Iterable<Object[]> listarPorIdPelicula();
//	
}
